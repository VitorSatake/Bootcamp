...
class Lista {
    public static void main(String[] args) {
        ...
        notas.remove(0d); // colocar o d para saber que é o valor 0 e nao posição 0
        System.out.println(notas);
        ...
        System.out.println("Confira se a lista está vazia: " + notas.isEmpty()); // retorna true or false para saber se está vazia
